    ...
    checkAndSendMessages() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const clients = yield this.getClientsToNotify();
    ...
    getClientsToNotify() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const toNotify = clientList.filter((client) => {
    ...
    sendMessage(client) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const textResponse = yield fetch(`${apiConfig.apiUrl}/message/sendText/${apiConfig.instanceName}`, {
                    method: 'POST',
                    headers: {
                ...
                const textResult = yield textResponse.text();
                if (!textResponse.ok) {
                ...
                const mediaResponse = yield fetch(`${apiConfig.apiUrl}/message/sendMedia/${apiConfig.instanceName}`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'apikey': apiConfig.apiKey
                ...
                const mediaResult = yield mediaResponse.text();
                if (!mediaResponse.ok) {
                ...
                const pixTextResponse = yield fetch(`${apiConfig.apiUrl}/message/sendText/${apiConfig.instanceName}`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'apikey': apiConfig.apiKey
                ...
                const pixResult = yield pixTextResponse.text();
                if (!pixTextResponse.ok) {
                    throw new Error(`Erro ao enviar código PIX: ${pixResult}`);
                }
                // Atualiza a data do último envio
                const updatedClient = Object.assign(Object.assign({}, client), { lastBillingDate: new Date().toISOString().split('T')[0] });
